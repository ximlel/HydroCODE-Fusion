...
ar crvs Riemann_solver.a Riemann_solver_exact_Ben.o Riemann_solver_exact_Toro.o linear_GRP_solver_LAG.o linear_GRP_solver_Edir.o
...
cd ../hydrocode
gcc -c ./hydrocode.c -g
gcc -o hydrocode.out ./hydrocode.o ../file_io/file_io.a ../finite_difference_solver/finite_difference_solver.a ../Riemann_solver/Riemann_solver.a -lm
