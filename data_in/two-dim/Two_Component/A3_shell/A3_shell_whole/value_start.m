...
for i=1:line
    ...
    elseif(norm(near_p)>R_2 && norm(far_p)<R_3)
       ...
       PHI(j,i) = 0;
       RHO(j,i) = rho_23;
       U(j,i) = quad2d(u_fun,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-8);
       V(j,i) = quad2d(v_fun,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-8);
       P(j,i) = p;
    ...
    elseif(norm(near_p)<R_1)
       CC(j,i) = quad2d(idx_1,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-3);
    ...
    elseif(norm(near_p)<R_2)
       ...
       PHI(j,i) = 0;
       RHO(j,i) = rho_23;
       U(j,i) = quad2d(u_full_fun,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-1);
       V(j,i) = quad2d(v_full_fun,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-1);
       P(j,i) = p;
    else
       CC(j,i) = quad2d(idx_3,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-3);
       RHO(j,i) = CC(j,i)*rho_4+(1.0-CC(j,i))*rho_23;
       PHI(j,i) = CC(j,i)*rho_4/RHO(j,i);
       U(j,i) = quad2d(u_full_fun,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-1)*rho_23/RHO(j,i);
       V(j,i) = quad2d(v_full_fun,center-j,center-j+1,i-center-1,i-center,'AbsTol',1e-1)*rho_23/RHO(j,i);
